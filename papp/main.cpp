    ...
    void defineOptions(Poco::Util::OptionSet& options)
    {
        ...
        options.addOption(
                Poco::Util::Option("help", "h", "display help information on command line arguments")
                        .required(false)
                        .repeatable(false)
                        .callback(Poco::Util::OptionCallback<SampleApp>(this, &SampleApp::handleHelp)));
        ...
        options.addOption(
                Poco::Util::Option("define", "D", "define a configuration property")
                        ...
                        .repeatable(true)
                        .argument("name=value")
                        .callback(Poco::Util::OptionCallback<SampleApp>(this, &SampleApp::handleDefine)));
        ...
        options.addOption(
                Poco::Util::Option("config-file", "f", "load configuration data from a file")
                        ...
                        .repeatable(true)
                        .argument("file")
                        .callback(Poco::Util::OptionCallback<SampleApp>(this, &SampleApp::handleConfig)));
